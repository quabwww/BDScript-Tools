...
async def send_blackjack_embed(user_id: str, request: EmbedRequest):
    ...
    blackjack_response = requests.get("https://bdscript-tools.onrender.com/blackjack/nuevo/")
    ...
    discord_response = requests.post(f"https://discord.com/api/v10/channels/{request.channel_id}/messages", json=data, headers=headers)
